...
Original file is located at
    https://colab.research.google.com/drive/1vf1Fh2ZYKUmTFwj2TE4v8V225IL1d5JH
"""
...
def build_model(hp):
    ...
    # Second GRU layer
    model.add(GRU(units=hp.Int('units_2', min_value=50, max_value=100, step=50), return_sequences=True))
    model.add(Dropout(hp.Float('dropout_2', 0.1, 0.5, step=0.1)))

    # Third GRU layer (without return_sequences)
    model.add(GRU(units=hp.Int('units_3', min_value=25, max_value=75, step=25)))
...
print(f'Mean Absolute Error (MAE) of GRU: {mae}')
print(f'Mean Absolute Percentage Error (MAPE) of GRU: {mape}%')
print(f'R-squared (R²) of GRU: {r2}')
