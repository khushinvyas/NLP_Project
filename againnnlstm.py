...
Original file is located at
    https://colab.research.google.com/drive/1LivnJtF5JV70WI-xQe5sQ5MuaIyRtF89
"""
...
def build_model(hp):
    ...
    # Second LSTM layer
    model.add(LSTM(units=hp.Int('units_2', min_value=50, max_value=100, step=50), return_sequences=True))
    model.add(Dropout(hp.Float('dropout_2', 0.1, 0.5, step=0.1)))

    # Third LSTM layer (without return_sequences)
    model.add(LSTM(units=hp.Int('units_3', min_value=25, max_value=75, step=25)))
...
print(f'Mean Absolute Error (MAE) of LSTM: {mae}')
print(f'Mean Absolute Percentage Error (MAPE) of LSTM: {mape}%')
print(f'R-squared (R²) of LSTM: {r2}')
